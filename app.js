...
async function main() {
    try {
        ...
        sites_proxy.sort((a, b) => a.value.localeCompare(b.value));
        sites_direct.sort((a, b) => a.value.localeCompare(b.value));
        sites_reject.sort((a, b) => a.value.localeCompare(b.value));
